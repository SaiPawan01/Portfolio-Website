...
function Hero() {
  return (
    <div className='md:w-[70%] md:flex justify-between pl-5 pr-5 gap-5 m-auto mt-5 text-white'>
      <div className='md:w-[55%] flex flex-col justify-start gap-3 md:gap-5 mb-5'>
        ...
        <p className='text-sm leading-5 text-[#ABB2BF]'>A final-year Computer Science(AI & ML) student at Anil Neerukonda Institute of Technology and Sciences(ANITS), passionate about web development and machine learning.</p>
